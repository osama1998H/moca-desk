...
function resolveDocValue(path: string, doc: DocValues): unknown {
...
function evaluateClause(clause: string, doc: DocValues): boolean {
 ...
 */
export function evaluateMandatoryDependsOn(
  expression: string | undefined,
  doc: DocValues,
): boolean {
